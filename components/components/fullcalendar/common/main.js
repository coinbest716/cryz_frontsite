...
function timeAsMs(m) {
  return (
    m.getUTCHours() * 1000 * 60 * 60 + m.getUTCMinutes() * 1000 * 60 + m.getUTCSeconds() * 1000 + m.getUTCMilliseconds()
  )
}
...
var PureComponent = /** @class */ (function (_super) {
  ...
  PureComponent.prototype.shouldComponentUpdate = function (nextProps, nextState) {
    ...
    return (
      !compareObjs(this.props, nextProps, this.propEquality) || !compareObjs(this.state, nextState, this.stateEquality)
    )
  }
