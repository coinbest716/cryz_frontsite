...
const DisciplineSection = () => {
  ...
  const BoxInfo = [
    ...
    { id: 3, bgColor: '#F1F1F1', title: 'Menopausia', image: '/images/card3.png', link: '/female-health/menopause' },
    { id: 4, bgColor: '#99A7A9', title: 'Postparto', image: '/images/card4.png', link: '/female-health/postpartum' },
    { id: 5, bgColor: '#d9dfdf', title: 'Embarazo', image: '/images/card1.png', link: '/female-health/pregnancy' },
    {
      id: 6,
      bgColor: '#e8ebeb',
