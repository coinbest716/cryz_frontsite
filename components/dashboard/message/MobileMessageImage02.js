...
// styles
import styles from 'components/components/dashboard/message/MobileMessageImage02.module.scss'

// images and icons
import DownloadIcon from 'assets/images/download-gray.svg'

const MobileMessageImage02 = props => {
  const { message } = props
...
export default MobileMessageImage02
