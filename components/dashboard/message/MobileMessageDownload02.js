...
// styles
import styles from 'components/components/dashboard/message/MobileMessageDownload02.module.scss'

// images and icons
import DownloadIcon from 'assets/images/download-gray.svg'

const MobileMessageDownload02 = props => {
  const { message } = props
...
export default MobileMessageDownload02
