  ...
  return (
    <div className={'flex justify-center'}>
      <div className={globalStyles.container}>
        <div className={styles.title}>Política de cookies</div>
        ...
        <div className={styles.text}>
          ...
          otros, permiten a una página web almacenar y recuperar información sobre los hábitos de navegación de un
          usuario o de su equipo y, dependiendo de la información obtenida, se pueden utilizar para reconocer al usuario
        ...
        <div className={styles.text}>
          <li className={'ml-4'}>
            ...
            es gestionado por el editor, sino por otra entidad que trata los datos obtenidos través de las cookies.
          </li>
        </div>
        <br />
        {/* paragraph */}
        ...
        <div className={styles.text}>
          <li className={'ml-4'}>
            ...
            el idioma, el tipo de navegador a través del cual accede al servicio, la configuración regional desde donde
        ...
        <div className={styles.text}>
          <li className={'ml-4'}>
            ...
            de diferentes plataformas sociales (facebook, youtube, twitter, linkedIn, etc..) y que se generen únicamente
            para los usuarios de dichas redes sociales. Las condiciones de utilización de estas cookies y la información
            recopilada se regula por la política de privacidad de la plataforma social correspondiente.
          </li>
        </div>
        <br />
        {/* paragraph */}
        ...
        <div className={styles.text}>
          ...
          consultarse el menú de Ayuda del navegador dónde puedes encontrar instrucciones. El usuario podrá en cualquier
        ...
        <div className={styles.text}>
          <li className={'ml-8'} style={{ listStyleType: 'circle' }}>
            Descripción: Recopila información anónima sobre la navegación de los usuarios por el sitio web con el fin de
            conocer el origen de las visitas y otros datos estadísticos. Esta cookie normalmente se almacena en el
            navegador en la primera visita a nuestro sitio web. Si la cookie ha sido borrada a través del navegador y
            posteriormente vuelve a visitar nuestro sitioweb, una nueva cookie del tipo _utma se escribe con un ID único
            diferente. Esta cookie se utiliza para determinar visitantes únicos a nuestro sitio web y se actualiza con
            cada vista de página. Adicionalmente, esta cookie proporciona un identificador único que Google Analytics
            utiliza para asegurar la validez y la accesibilidad de la cookie, así como una medida de seguridad extra.
          </li>
        </div>
        <br />
        {/* paragraph */}
