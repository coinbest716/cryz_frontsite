      ...
      <div className={globalStyles.container}>
        ...
        <div className={mobile && styles.mobileContent}>
          ...
          <div className={styles.text}>
            ...
            mantenimiento de la relación comercial y el desempeño de tareas de información, formación, asesoramiento y
            otras actividades propias de Crody Salud S.L.
          </div>
          <br />
          <div className={styles.text}>
          ...
          <br />
          <div className={styles.text}>
            Crody Salud S.L. adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad
            de los datos conforme a lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de
            27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de
            datos personales y a la libre circulación de los mismos, y derogando la antigua LOPD, la nueva Ley Orgánica
            3/2018, de 5 diciembre, de Protección de Datos y Garantía de los Derechos Digitales (LOPDGDD).
          </div>
          <br />
          <div className={styles.text}>
            El usuario podrá en cualquier momento ejercitar los derechos de acceso, oposición, rectificación,
            cancelación, limitación y portabilidad reconocidos en el citado Reglamento (UE). El ejercicio de estos
            derechos puede realizarlo el propio usuario a través de email a: administracion@crysdyazandco.com o en la
            dirección: C/ Azalea, 1, Locales A y 2, Edificio F, Polígono Empresarial Minipark, C.P. 28109 – Alcobendas
            (Madrid).
          </div>
          <br />
          <div className={styles.text}>
          ...
          <div className={styles.text}>
            <p>
              Crody Salud S.L. es titular de todos los derechos de autor, propiedad intelectual, industrial, “know how”
              y cuantos otros derechos guardan relación con los contenidos del sitio web&nbsp;
              <a href={'https://crysdyazandco.com/'}>https://crysdyazandco.com/</a> y los servicios ofertados en el
              mismo, así como de los programas necesarios para su implementación y la información relacionada.
            </p>
          </div>
          <br />
          <div className={styles.text}>
          ...
          <div className={styles.text}>
            ...
            excepción hecha de los derechos y licencias necesarios para el cumplimiento de los servicios contratados y
          ...
          <div className={styles.text}>
            ...
            por parte de Crody Salud S.L., quedando prohibido al usuario acceder, modificar, visualizar la
            configuración, estructura y ficheros de los servidores propiedad de Crody Salud S.L., asumiendo la
          ...
          <div className={styles.text}>
            ...
            Crody Salud S.L. y, en particular de:
          </div>
          <br />
          <div className={styles.text}>
          ...
          <div className={styles.text}>
            ...
            almacenada, los enlaces de hipertexto, las reivindicaciones de terceros y las acciones legales en referencia
          ...
          <div className={styles.text}>
            ...
            funcionamiento del servicio online, comercio electrónico, derechos de autor, mantenimiento del orden
          ...
          <div className={styles.text}>
            ...
            podrían haber sido suprimidos y/o modificados durante el periodo del tiempo transcurrido desde la última
            copia de seguridad.
          </div>
          <br />
          <div className={styles.text}>
          ...
          <br />
          <div className={styles.text}>
            En aplicación de la LSSI. Crody Salud S.L. no enviará comunicaciones publicitarias o promocionales por
          ...
          <br />
          <div className={styles.text}>
            En el caso de usuarios con los que exista una relación contractual previa, Crody Salud S.L. sí está
            autorizado al envío de comunicaciones comerciales referentes a productos o servicios de Crody Salud S.L. que
