    ...
    <div className="flex justify-center">
      <div className={globalStyles.container}>
        ...
        <div className={styles.text}>
          ...
          etc.), cuya Propiedad Intelectual le corresponde a EL PROPIETARIO, salvo en lo referente a aquellos materiales
          obtenidos bajo licencia de terceros.
        </div>
        <br />
        <div className={styles.text}>
          ...
          (cualquiera que sea el soporte al que se incorporen), concediendo sobre los mismos únicamente los derechos de
          uso que más adelante se describen. Cualquier derecho que no sea expresamente cedido se entiende reservado.
        </div>
        <br />
        <div className={styles.text}>
          Además de lo anterior, EL PROPIETARIO es responsable de la selección, diseño de la estructura y disposición de
          los contenidos de la Web, así como quien ha tomado la iniciativa y asumido el riesgo de efectuar las
        ...
        <div className={styles.text}>
          ...
          legales pertinentes que le pudieran corresponder contra las personas que realicen imitaciones o usos desleales
          del mismo.
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Beneficiarse (previo registro), de los servicios y ventajas prestados por EL PROPIETARIO a través de la Web a
          sus usuarios, en las condiciones que se señalen expresamente en las distintas secciones.
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Cualquier utilización fuera del ámbito personal y privado, especialmente aquellas que tengan fines comerciales
          o profesionales, incluido el envío de publicidad o mensajes y la recopilación y tratamiento de datos de
          terceros.
        </div>
        <br />
        <div className={styles.text}>
          Cualquier tipo de extracción, comunicación pública y/o transmisión, total o parcial, por cualquier medio,
          fuera del ámbito privado de uso permitido y, especialmente, su incorporación a cualquier otra obra, incluidas
          páginas web, colecciones o bases de datos. Se exceptúa de esta prohibición la publicación en medios de
          comunicación de los materiales susceptibles de descarga de la sección Sala de Prensa.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          Generales y, en general, cualquiera que pueda perjudicar el normal funcionamiento de la Web, a otros usuarios
        ...
        <div className={styles.text}>
          ...
          siempre que los mismos no se hagan de forma que perjudique la imagen pública y de marca de EL PROPIETARIO, de
          la Web o de cualquiera de las personas y productos a que se haga referencia en la misma. En el establecimiento
          de vínculos con la Web queda expresamente prohibida la utilización de técnicas que impliquen confusión sobre
          la identidad y propiedad de los contenidos, tales como el framing u otras.
        </div>
        <br />
        <div className={styles.text}>
          Queda prohibido el establecimiento de vínculos desde páginas o sitios web cuyos contenidos promocionen o hagan
          apología, directa o indirectamente, de cualquier tipo de violencia, discriminación, pornografía o actividad
          ilegal. Asimismo, queda expresamente prohibido el establecimiento de links con fines mercantiles.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          alguna de EL PROPIETARIO sobre los mismos, por lo que EL PROPIETARIO no será responsable en absoluto respecto
          de su contenido y licitud.
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Difundir contenidos o propaganda de carácter racista, xenófobo, pornográfico, que haga apología del terrorismo
          o que atente contra los derechos humanos.
        </div>
        <br />
        <div className={styles.text}>
          Provocar daños en los sistemas físicos y lógicos de EL PROPIETARIO, de sus proveedores o de terceras personas,
        ...
        <br />
        <div className={styles.text}>
          Atentar contra los derechos de Propiedad Intelectual, Industrial, de imagen, honor u otros que correspondan a
          EL PROPIETARIO o a terceros (queda expresamente prohibido hacer copia o grabación y divulgacion de las
        ...
        <br />
        <div className={styles.text}>
          La información o datos personales que nos facilite serán tratados con arreglo a lo establecido en la Política
          de Privacidad. Al hacer uso de esta página web se consiente el tratamiento de dicha información y datos y se
          declara que toda la información o datos que nos facilite son veraces y se corresponden con la realidad.
        </div>
        <br />
        <div className={styles.text}>MODIFICACIONES</div>
        <br />
        <div className={styles.text}>
          EL PROPIETARIO se reserva el derecho de efectuar, sin previo aviso, las modificaciones que considere oportunas
          en la Web, pudiendo cambiar, suprimir o añadir tanto los contenidos y servicios que se presten a través de la
          misma, como la forma en la que éstos aparezcan presentados o localizados.
        </div>
        <br />
        <div className={styles.text}>
          ...
          garantizada la obtención de ningún resultado o fin concreto, por lo que el acceso y utilización de la Web, es
          de exclusiva responsabilidad de los usuarios y clientes.
        </div>
        <br />
        ...
        <div className={styles.text}>
          ...
          licenciantes, especialmente los de Propiedad Intelectual e Industrial, ejercitando todas las acciones, civiles
          y penales, que le puedan corresponder en Derecho.
        </div>
        <br />
