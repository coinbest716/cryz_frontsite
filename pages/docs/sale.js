  ...
  return (
    <div className="flex justify-center">
      <div className={globalStyles.container}>
        <div className={styles.title}>Condiciones de venta</div>
        <div className={styles.divider} />
        <div className={styles.text}>Titular: Crody Salud S.L.</div>
        <br />
        <div className={styles.text}>
          Domicilio social: C/ Azalea, 1, Locales A y 2, Edificio F, Polígono Empresarial Minipark. – 28109 – Alcobendas
          (Madrid)
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Registro Público: Inscrita en el Registro Mercantil de Madrid Tomo 40773, Folio 160, Sección 8ª, Hoja 723347,
          Inscripción 1ª.
        </div>
        <br />
        ...
        <div className={styles.text}>
          ...
          modificaciones y/o textos legales adicionales que sean incluidas en el futuro. En caso de no estar de acuerdo
          con alguna de las condiciones, puedes darte de baja del servicio en cualquier momento o en caso de no ser
          usuario registrado, abandonar la plataforma.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          efectos previstos por el ordenamiento jurídico, siempre que concurra el consentimiento de ambas partes y éste
        ...
        <br />
        <div className={styles.text}>
          Del mismo modo, y atendiendo a lo dispuesto en el artículo 27 de la Ley 34/2002 de servicios de la sociedad de
          la información y de comercio electrónico, se pone a disposición de los usuarios, de forma previa al inicio del
          procedimiento de contratación toda la información relativa al mismo.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <br />
        <div className={styles.text}>Cualquier persona con acceso a Internet puede llevar a cabo la contratación.</div>
        <br />
        <div className={styles.text}>
          Las fases del procedimiento de contratación son visibles para los usuarios a lo largo de todo el procedimiento
          de contratación. Pueden diferenciarse 3 fases:
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Una vez seleccionado el servicio o producto, la cantidad, los impuestos aplicables, el precio total y el medio
          de pago, la plataforma mostrará al usuario un resumen de la contratación realizada, junto a las condiciones de
          contratación aplicables, que en todo caso deberán ser expresamente aceptadas por el usuario para poder seguir
        ...
        <br />
        <div className={styles.text}>
          En caso de haberse seleccionado el pago mediante tarjeta de crédito, éste se llevará a cabo a través de la TPV
          del banco, plataforma completamente ajena e independiente del prestador.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <br />
        <div className={styles.text}>
          El prestador informa al usuario de que todas las contrataciones realizadas quedarán registradas en un fichero
          para el control y gestión de contrataciones, en el que quedarán reflejados junto a la información de los
          servicios contratados, información adicional para garantizar la seguridad y evidencia de la correcta
        ...
        <div className={styles.text}>
          ...
          complementarias, junto con el artículo 45 de la Ley 7/1996, del Comercio Minorista, el usuario tiene derecho a
          desistir del contrato durante el plazo de desde el momento en que se ha contratado el servicio.
        </div>
        <br />
        <div className={styles.text}>
          Para ejercer el derecho al desistimiento, el usuario simplemente deberá solicitarlo por escrito a cualquiera
          de las direcciones mencionadas a continuación, indicando expresamente su solicitud de ejercicio del derecho de
          desistimiento:
        </div>
        <br />
        <div className={styles.text}>
          Dirección Postal: C/ Azalea, 1, Locales A y 2, Edificio F, Polígono Empresarial Minipark. – 28109 – Alcobendas
          (Madrid)
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Una vez recibida la solicitud de ejercicio del derecho de desistimiento, procederemos a restituir la cantidad
          económica abonada (sin que en ningún caso se incluyan los gastos de envío y de gestión que se hubieran podido
          abonar inicialmente) en el plazo máximo de 30 días desde el momento de la recepción del desistimiento y
          siempre a través del medio utilizado para abonar el servicio, o en su defecto mediante transferencia bancaria.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <br />
        <div className={styles.text}>
          Productos precintados y no aptos para ser devueltos por razones de higiene, que pueden desprecintarse tras la
          entrega.
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          A la atención de (aquí deberá insertar el nombre de la empresa, dirección completa y, si dispone de ellos, el
        ...
        <br />
        <div className={styles.text}>Nombre y domicilio del consumidor y usuario o de los consumidores y usuarios.</div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          El cliente o usuario podrá cancelar su pedido, siempre y cuando éste no haya salido de nuestros almacenes. En
          tal caso, deberá ponerse en contacto a través del correo electrónico o de los canales de Atención al Cliente,
          comunicando sus datos identificativos y número de referencia del pedido. En caso de cancelaciones se procederá
          a la devolución de los importes abonados previamente por el usuario o cliente, a través del mismo medio
          empleado para la transacción inicial.
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Realizamos envíos exclusivamente en península, si desea que envíemos su producto a Canarias o fuera de España,
          rogamos contacten con Atención al cliente.
        </div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          Todos nuestros productos se envían en un plazo de 48/72 horas desde su tramitación. A excepción de los bonos y
          el contenido digital, que recibirá en 24 horas.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          estuvieren orientados a hacer posible el acceso de terceros a la plataforma o a cualquiera de sus componentes,
          a través de operaciones de alquiler, servicios administrativos o cualesquiera otros de análoga consideración,
          compartiéndolos o poniéndolos a disposición de terceros.
        </div>
        <br />
        <div className={styles.text}>
          No someter la plataforma o cualesquiera de sus elementos, a actividades encaminadas, directa o indirectamente
          a la descompilación de su software, que impliquen su sometimiento a operaciones de naturaleza inversa a las
          que determinaron su construcción o que, en último término, constituyan o puedan constituir operaciones de
          ingeniería inversa, descompilación o desensamblado. Ninguno de los apartados del presente contrato podrá
          entenderse como una autorización de acceso al código fuente de la plataforma.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          tipo de situaciones, el nivel de servicio acordado, no será de aplicación, siendo considerada una situación de
          emergencia, no asumiendo por tanto Crody Salud S.L. responsabilidad alguna por la falta de disponibilidad del
          servicio.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <br />
        <div className={styles.text}>
          No traducir, adaptar, mejorar, transformar, modificar ni corregir la plataforma o cualquiera de los elementos
          que la integren, no pudiendo incorporar la misma a otros software o portales propios o provistos por terceros.
        </div>
        <br />
        <div className={styles.text}>
          No retirar, suprimir, alterar, manipular ni en modo alguno modificar aquellas notas, leyendas, indicaciones o
          símbolos que el prestador, como legítimo titular de los derechos, incorpore a sus propiedades en materia de
          propiedad intelectual o industrial (como por ejemplo, copyright, ©, ® y TM, etc.) ya fuera en la propia
        ...
        <br />
        <div className={styles.text}>Queda prohibido forzar fallos o buscar brechas de seguridad en la plataforma.</div>
        <br />
        ...
        <br />
        <div className={styles.text}>
          En caso de que aparezca publicada en la plataforma información que no hubiera sido alojada por nuestra parte o
          que en su caso hubiera sido publicada por un tercero ajeno a la organización.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          contra la moral, el orden público, los derechos fundamentales, las libertas públicas, el honor, la intimidad o
        ...
        <br />
        <div className={styles.text}>
          El usuario reconoce expresamente que el prestador ostenta todo derecho, título e interés sobre la plataforma y
          los desarrollos informáticos asociados al servicio, así como sobre todos sus módulos, modificaciones y
        ...
        <div className={styles.text}>
          ...
          misma, herramientas de desarrollo, know-how, metodologías, procesos, tecnologías o algoritmos que constituyan
          y/o puedan constituir la plataforma, son propiedad exclusiva del prestador, encontrándose debidamente
          protegidos por las leyes nacionales e internacionales de propiedad intelectual y/o industrial, no pudiendo ser
          objeto de ulterior modificación, copia, alteración, reproducción, adaptación o traducción por parte del
          usuario, sin que exista el previo consentimiento expreso por parte del prestador.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          en ningún caso, la cesión de su titularidad, ni la concesión de un derecho de uso a favor del usuario distinto
          del expresado en estas condiciones.
        </div>
        <br />
        <div className={styles.text}>
          ...
          temporal limitado a cada periodo de conexión, de ámbito espacial ilimitado en la medida en que puede accederse
          desde cualquier equipo con Internet, intransferible, revocable y no sublicenciable.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          reservados todos los derechos a favor del prestador siendo necesaria la autorización escrita por parte de éste
        ...
        <br />
        <div className={styles.text}>
          De conformidad con lo dispuesto por el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de
          abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos
          personales y a la libre circulación de estos, todos los datos de carácter personal facilitados durante la
          utilización de la plataforma y durante la prestación de los servicios serán tratados de conformidad con lo
          dispuesto en la Política de Privacidad, que todo usuario debe aceptar expresamente y de forma previa para
          poder registrarse.
        </div>
        <br />
        <div className={styles.text}>
          ...
          cancelación y oposición respecto a sus datos de carácter personal, pudiendo ejercerlos según se informa en la
          mencionada Política de Privacidad.
        </div>
        <br />
        <div className={styles.text}>CONDICIONES TEMPORALES</div>
        <br />
        <div className={styles.text}>
          Las presentes condiciones entrarán en vigor en la fecha de la contratación del servicio y tendrán una duración
          de un año, renovándose de forma tácita por períodos anuales.
        </div>
        <br />
        <div className={styles.text}>
          Cualquiera de las partes podrá dar por finalizado el presente contrato mediante comunicación expresa y escrita
          a la otra parte, al menos con 30 días de antelación al inicio del período siguiente.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <div className={styles.text}>
          ...
          válidas, salvo error tipográfico o de transcripción, caso en el que el prestador se compromete a modificarlas
          inmediatamente.
        </div>
        <br />
        <div className={styles.text}>
          En caso de que la modalidad de pago sea mediante domiciliación bancaria, el usuario acepta expresamente que el
          prestador realice periódicamente en los plazos indicados, los cargos económicos correspondientes en la cuenta
          bancaria del usuario.
        </div>
        <br />
        <div className={styles.text}>
          El prestador se reserva el derecho a anular las contrataciones realizadas durante el plazo de 7 días desde el
          momento de su realización en caso de que detecte la existencia de errores tipográficos o de transcripción en
          el precio y/o los impuestos aplicados a la transacción.
        </div>
        <br />
        <div className={styles.text}>
        ...
        <br />
        <div className={styles.text}>
          Todos los servicios contratados serán debidamente facturados y abonados de forma previa a la prestación de los
          servicios o a mes vencido, dependiendo de la modalidad de contratación empleada.
        </div>
        <br />
        <div className={styles.text}>
          Las cantidades económicas únicamente podrán ser abonadas mediante domiciliación bancaria o mediante tarjeta de
          crédito, no contando en ningún momento el prestador con acceso a ningún dato bancario o de las tarjetas de
          crédito.
        </div>
        <br />
        <div className={styles.text}>
