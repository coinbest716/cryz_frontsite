...
const Training = props => {
  ...
  const handleClick = type => {
    switch (type) {
      case 'type1':
        router.push({
          pathname: '/salud-kids/fisioterapia-pediatrica/servicios/personal',
          query: { discipline_id: 1, service_type: 'personal', type: 'service', image: imageOne || '' },
        })
        break
      case 'type2':
        router.push({
          pathname: '/salud-kids/fisioterapia-pediatrica/servicios/online',
          query: { discipline_id: 1, service_type: 'online', type: 'service', image: imageTwo || '' },
        })
        break
      case 'type3':
        router.push({
          pathname: '/salud-kids/fisioterapia-pediatrica/servicios/streaming',
