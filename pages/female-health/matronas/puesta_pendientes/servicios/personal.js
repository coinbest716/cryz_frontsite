        ...
        {viewport === 'mobile' ? (
          <div>
            ...
            <div className={globalStyles.tinyMCEClass}>
              <div className={'tinymce-class'}>Si estás dudando que se ajusta más a tus necesidades, ponte en contacto con nuestro equipo de especialistas para que te asesoren.</div>
            </div>
          </div>
        ) : (
